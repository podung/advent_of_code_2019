defmodule Day03Test do
  ...
  test "calculates sample data fewest steps correctly" do
    assert Day03.fewest_steps_to_closest_intersection(
      "R75,D30,R83,U83,L12,D49,R71,U7,L72",
  ...
  test "calculates input data fewest steps correctly" do
    [wire1, wire2] = "fixtures/day03_fixture.txt"
      |> File.read!
      |> split_lines

    assert Day03.fewest_steps_to_closest_intersection(wire1, wire2) == 20286
  end
end
